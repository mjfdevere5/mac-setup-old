...
# # Try between 1 and 4 according to http://superuser.com/questions/457153/getting-crisper-fonts-in-os-x-after-switching-from-windows
...
# Set download folder to ~/torrents/complete
...
for app in "Address Book" "Calendar" "Contacts" "Dock" "Finder" "Mail" "Safari" "SystemUIServer" "iCal" "Transmission"; do
